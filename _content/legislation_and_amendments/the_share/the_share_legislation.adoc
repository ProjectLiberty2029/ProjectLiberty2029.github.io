...
... As an example, 
.... if the Share Rate  is 88.957n%, and the US Gross Real Income for 2030 were to be $26.5 T, then the Share Amount  for 2031 would be  $23,043, and 
.... In this example, if the Fair Tax Rate  for that year were 28.9%, then every adult citizen over 18 (with a few exceptions) would receive a net Share Amount  of $16,383.57 (which would be the $23,043 share minus 28.9% in taxes), and 
.... In this example, each Share Recipient would receive two checks every month from the IRS for one twenty fourth of the net amount, or two checks a month for $682.65.  
...
.. Employee fringe benefits provided at or in close proximity to the place of work, such as promotional discounts, office food, use of gym equipment, entertainment, temporary housing, child care, etc..; footnote:[Originally from S-907; 108th Congress, “Flat Tax Act of 2003.”  ]
...
. Where Tax Credits specify amounts for individuals, or heads of household, or married persons filing jointly, or married persons filing separately, taxpayers shall be due the maximum Tax Credit defined under the assumption that a married couple can be divided into two equal individuals footnote:[There are a dizzying number of possible combinations of qualifying benefits that vary depending on the married or head-of-household status of taxpayers combined with the kind of filing.  The examples provided are based on Release Point 119-4, Section 22.] 
...
. Upon Enactment, the Fair Tax Rate  for the following two tax-years, shall be 29%.  
...
. _In General.--Title 26 shall be amended as follows:_ footnote:[It is widely believed but impossible under current law to substantiate that wealthy individuals and corporations make use of deductions to abuse the tax system while maintaining expensive life-styles and economic powers. By placing a window on extreme uses of deductions (over 2,000 times the Share Amount  would be deductions from corporate net income of over $4,000,000 in the first year, and over 20  will be deductions of $400,000 from individual income in the first year) will allow the public to better know the extent (if any) of the problem.  These income thresholds limit the impact of this to the top 5% of earners.  Once these deduction uses are known, the public can take further action through their representatives.]
...
[.indent]
“the net amount of any Share Amount  received, after taxes.” footnote:[The earned income credit may still be qualified for by large families with only a single Share Recipient parent.]
...
Any deduction specified in this part and claimed by any taxpayer who is a natural person where the value of the deduction is over 20 (twenty) times the Share Amount  for the year the deduction was claimed shall be reported to the public with the name of the taxpayer, the name of the taxpayer and the zip code of the taxpayer’s principal address, and if the taxpayer is not a natural person, the address and zip code of the taxpayer’s name of the taxpayer’s registered agent (if any).” footnote:[Section 161 enables all the tax deductions for corporations in Subtitle A, Chapter 1, Subchapter B, Part VI: Itemized Deductions for Individuals and Corporations.]
...
[.indent]
"(3)	no deduction under this section shall be allowed in excess of twenty (20) times the Share Amount  for the same year that the deduction is claimed." footnote:[Currently this section allows for an unlimited deduction for expensive hobbies.  It is theoretically possible to wipe out unlimited amounts of income by creating an S-Corporation to receive a person’s income, then raise horses, race yachts, climb mountains, with all the food and housing expenses required for those things, and deduct all the costs of those activities from taxable income.  This adds a limit to the amount deductible of 10  which is $200,000 in the first year.]
...
[.indent]
“Any deduction specified in this part and claimed by a taxpayer which has a value of over 20 (twenty) times the Share Amount  for the year the deduction was claimed shall be reported to the public with the name of the taxpayer and the zip code of the taxpayer’s principal address.” footnote:[Section 211 enables all the tax deductions for corporations in Subtitle A, Chapter 1, Subchapter B, Part VII: Additional Itemized Deductions for Individuals.  Setting a reporting limit of 20  means only those with the capacity to absorb $400,000 of expenses (in the first year) will face such reporting.  This is over the top 10% of income.]
...
[.indent]
“Any deduction specified in this part and claimed by a corporate taxpayer with publicly traded stock where the value of the deduction is over 2,000 (two-thousand) times the Share Amount  for the year the deduction was claimed shall be reported to the public with: the name of the taxpayer, the address and zip code of the taxpayer’s headquarters or principal place of business, and the name and address of the taxpayer’s registered agent (if any, and if the taxpayer has multiple registered agents, the primary registered agent designated for federal tax matters).  + 
Any deduction specified in this part and claimed by any taxpayer which is not a natural person and which is not included in the previous sentence where the value of the deduction is over 50 (fifty) times the Share Amount  for the year the deduction was claimed shall be reported to the public with the name of the taxpayer, the address and zip code of the taxpayer’s headquarters or principal place of business, and the name and address of the taxpayer’s registered agent (if any, and if the taxpayer has multiple registered agents, the primary registered agent designated for federal tax matters).” footnote:[Section 241 enables all the tax deductions for corporations in Subtitle A, Chapter 1, Subchapter B, Part VIII: Special Deductions for Corporations.  By placing a window on extreme uses of deductions (over 2,000 times the Share Amount  would be deductions from corporate net income of over $4,000,000 in the first year) will allow the public to better know the extent of abuses (if any) of the tax system.]
